...
def detect_color_checker(image):
    ...
    for checker in checkers:
        ...
        cv2.namedWindow('Detected ColorChecker', cv2.WINDOW_KEEPRATIO)
...
def calibrate_camera(calibration_file):
    ...
    cv2.namedWindow('Original Video', cv2.WINDOW_KEEPRATIO)
    cv2.namedWindow('Corrected Video', cv2.WINDOW_KEEPRATIO)
    ...
    if image_path and not calibration_file and not image_to_calibrate:
        ...
        if color_patches is not None:
            ...
            if model is not None:
                ...
                cv2.imwrite('calibrated_output_sin_luz.jpg', calibrated_image)
                ...
                cv2.namedWindow('Calibrated Image', cv2.WINDOW_KEEPRATIO)
...
if __name__ == "__main__":
    ...
    main(image_path="E:/Tesis/Pruebas_Domo_conico/test_domo_luz6500_lenspos_8_color_check_1.jpg")
